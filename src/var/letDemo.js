 ...
 * And the five instances of the callback function passed to the setTimeOut() function 
 * refers to the same variable i with the final value 5.
 */
for (var i = 0; i < 5; i++) {
    setTimeout(function () {
